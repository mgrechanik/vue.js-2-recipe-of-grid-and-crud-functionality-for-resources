...
4. Следуя этому рецепту вы получите быстрый старт для запуска следующего функционала вокруг управления моделью:
    ...
    * Страница списка моделей со следующими функциями:
	  ...
	  * информация какие модели из скольки показаны на текущей странице
	  * пагинатор для перехода на нужную страницу (данные кешируются, если уже грузили данные для этой странице, то не перезагружаем)
